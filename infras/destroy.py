...
try:
    command_a = input(f"You are about to destroy the stack in the {accounts[account_id]} account - Are you sure? (y/n)")
except: 
...
if command_a.lower() == 'y':
    ...
    command_b = input("Are you sure you want to destroy the entire stack? Type 'destroy' to confirm: ")
